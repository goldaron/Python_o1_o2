...
# Nyt pätee n/N≈π/4, josta saadaan π≈4n/N. Kirjoita ohjelma, joka kysyy arvottavien pisteiden määrän käyttäjältä ja toteuttaa piin likiarvon laskennan edellä kuvatulla menetelmällä.
...
# Kysytään käyttäjältä pisteiden määrä (N):
N = int(input("Anna arvottavien pisteiden määrä: "))

# Lasketaan moniko osuu ympyrän sisälle (n) annetulla kaavalla: x^2 + y^2 < 1
# Generoidaan satunnaiset liukuluvut neliön sisälle
...
#Likiarvon laskeminen π≈4n/N
pi_likiarvo = 4 * n / N

print(f"Piin likiarvo {N} pisteellä on {pi_likiarvo:.15f}.")